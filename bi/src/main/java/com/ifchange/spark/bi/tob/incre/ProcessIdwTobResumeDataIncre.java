package com.ifchange.spark.bi.tob.incre;
...
import com.ifchange.spark.bi.bean.tob.incre.*;
 ...
 * base_industry
 */
public class ProcessIdwTobResumeDataIncre {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessIdwTobResumeDataIncre.class);
    ...
    public static void main(String[] args) {
        ...
        conf.set("spark.sql.warehouse.dir", "/user/parquet/warehouse");

        SparkSession sparkSession = SparkSession.builder().config(conf).enableHiveSupport().getOrCreate();

        //加载industry_mapping /user/parquet/warehouse/edw_dim_dimension.db/industry_mapping/part-00000-c0e3973b-671c-4549-a23d-6289f643bc6d-c000.txt
        ...
        Dataset<IdwTobBaseDataIncre> idwTobBaseDataDataset = resumeExtraDataset
            ...
            .map((MapFunction<Row, IdwTobBaseDataIncre>) row -> {
                IdwTobBaseDataIncre idwTobBaseData = new IdwTobBaseDataIncre();
                ...
                if (StringUtils.isNoneBlank(compressStr)) {
                    ...
                    if (null != jsonObject) {
                        ...
                        if (null != basic) {
                             ...
                             * base_common
                             */
                            IdwTobBaseCommonIncre baseCommon = new IdwTobBaseCommonIncre();
                            baseCommon.setDay(date);
                            ...
                            idwTobBaseData.setBaseCommonIncre(baseCommon);
                        }

                        /*
                         * base_contact
                         */
                        IdwTobBaseContactIncre baseContact = new IdwTobBaseContactIncre();
                        ...
                        if (contact instanceof Map) {
                            ...
                            if (contactMap.size() > 0) {
                                ...
                                baseContact.setDay(date);
                                idwTobBaseData.setBaseContactIncre(baseContact);
                            }
                         ...
                         * base_education
                         */
                        List<IdwTobBaseEducationIncre> baseEducations = new ArrayList<>();
                        ...
                        if (education instanceof Map) {
                                ...
                                for (Map.Entry<String, Object> entry : educationSort.entrySet()) {
                                    ...
                                    if (value1 instanceof Map) {
                                        ...
                                        if ("N".equals(isDeleted)) {
                                            IdwTobBaseEducationIncre baseEducation = new IdwTobBaseEducationIncre();
                                            baseEducation.setDay(date);
                                            ...
                                            //school_name
                                            Object schoolName1 = value.get("school_name");
                                            String schoolName = null != schoolName1 ? String.valueOf(schoolName1) : "";
                                            baseEducation.setSchool_name(schoolName);
                                            //major_name
                                            Object disciplineName = value.get("discipline_name");
                                            String majorName = null != disciplineName ? String.valueOf(disciplineName) : "";
                            ...
                            idwTobBaseData.setBaseEducationIncres(baseEducations);
                        }
                         ...
                         * base_function
                         */
                        List<IdwTobBaseFunctionIncre> baseFunctions = new ArrayList<>();
                        if (StringUtils.isNoneBlank(cvTag) && !StringUtils.equals("\"\"", cvTag)) {
                                    ...
                                    if (value1 instanceof Map) {
                                        ...
                                        if (StringUtils.isNoneBlank(category)) {
                                            ...
                                            if (split.length == 2) {
                                                ...
                                                IdwTobBaseFunctionIncre baseFunction = new IdwTobBaseFunctionIncre();
                            ...
                            idwTobBaseData.setBaseFunctionIncres(baseFunctions);
                        }

                        /*
                         * base_company
                         */
                        List<IdwTobBaseCompanyIncre> baseCompanys = new ArrayList<>();
                        if (StringUtils.isNoneBlank(cvTrade)) {
                            ...
                            if (null != array && array.size() > 0) {
                                for (Integer i = 0; i < array.size(); i++) {
                                    IdwTobBaseCompanyIncre baseCompany = new IdwTobBaseCompanyIncre();
                                    baseCompany.setDay(date);
                            ...
                            idwTobBaseData.setBaseCompanyIncres(baseCompanys);
                        }
                         ...
                         */
                        if (null != basic) {
                            IdwTobBaseSalaryIncre baseSalary = new IdwTobBaseSalaryIncre();
                            baseSalary.setDay(date);
...
//                                                            Pattern.compile("^(\\d+|\\d+\\.\\d+)$");
                            ...
                            baseSalary.setExpect_salary_from(expectAnnualSalaryFrom);
                            ...
                            idwTobBaseData.setBaseSalaryIncre(baseSalary);
                        }

                        /*
                         * base_work
                         */
                        List<IdwTobBaseWorkIncre> baseWorks = new ArrayList<>();
                        ...
                        if (work instanceof Map) {
                            ...
                            if (sortWork.size() > 0) {
                                for (Map.Entry<String, Object> entry : sortWork.entrySet()) {
                                    ...
                                    if (value instanceof Map) {
                                        ...
                                        if ("N".equals(isDeleted)) {
                                            IdwTobBaseWorkIncre baseWork = new IdwTobBaseWorkIncre();
                                            baseWork.setDay(date);
                            ...
                            idwTobBaseData.setBaseWorkIncres(baseWorks);
                        }
                         ...
                         * base_work_salary
                         */
                        List<IdwTobBaseWorkSalaryIncre> baseWorkSalaries = new ArrayList<>();
                        if (work instanceof Map) {
                            Map<String, Object> workJson = (Map<String, Object>) work;
                            if (workJson.size() > 0) {
                                Map<String, Object> sortWork = SortMapUtils.workSort(workJson);
                                for (Map.Entry<String, Object> entry : sortWork.entrySet()) {
                                    ...
                                    if (value instanceof Map) {
                                        ...
                                        String isDeleted = null != workDetail.get("is_deleted") ?
                                            String.valueOf(workDetail.get("is_deleted")) : "N";
                                        if ("N".equals(isDeleted)) {
                                            IdwTobBaseWorkSalaryIncre baseWorkSalary = new IdwTobBaseWorkSalaryIncre();
                                            baseWorkSalary.setDay(date);
...
//                                                            Pattern.compile("^(\\d+|\\d+\\.\\d+)$");
                            ...
                            idwTobBaseData.setBaseWorkSalaryIncres(baseWorkSalaries);
                        }
                        ...
                        if (StringUtils.isNoneBlank(cvTrade)) {
                            ...
                            idwTobBaseData.setBaseIndustryTempIncres(baseIndustryTemps);
                        }
                         ...
                         * base_level
                         */
                        List<IdwTobBaseLevelIncre> baseLevels = new ArrayList<>();
                        if (StringUtils.isNoneBlank(cvTitle) && !StringUtils.equals("\"\"", cvTitle)) {
                            ...
                            if (null != cvTitleJson && cvTitleJson.size() > 0) {
                                for (Map.Entry<String, Object> entry : cvTitleJson.entrySet()) {
                                    IdwTobBaseLevelIncre baseLevel = new IdwTobBaseLevelIncre();
                                    baseLevel.setDay(date);
                            ...
                            idwTobBaseData.setBaseLevelIncres(baseLevels);
                        }
                    }
                }
                return idwTobBaseData;
            }, Encoders.bean(IdwTobBaseDataIncre.class));

        idwTobBaseDataDataset.persist();

        Dataset<IdwTobBaseCommonIncre> baseCommonDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) ds -> null != ds.getBaseCommonIncre())
            .map((MapFunction<IdwTobBaseDataIncre, IdwTobBaseCommonIncre>) IdwTobBaseDataIncre::getBaseCommonIncre, Encoders.bean(IdwTobBaseCommonIncre.class));

//        Dataset<IdwTobBaseContactIncre> baseContactDs = idwTobBaseDataDataset
//            .filter((FilterFunction<IdwTobBaseDataIncre>) ds -> null != ds.getBaseContactIncre())
//            .map((MapFunction<IdwTobBaseDataIncre, IdwTobBaseContactIncre>) IdwTobBaseDataIncre::getBaseContactIncre, Encoders.bean(IdwTobBaseContactIncre.class));


        Dataset<IdwTobBaseEducationIncre> baseEducationDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseEducationIncres() && odsBaseData.getBaseEducationIncres().size() > 0)
            .flatMap((FlatMapFunction<IdwTobBaseDataIncre, IdwTobBaseEducationIncre>) odsBaseData -> {
                List<IdwTobBaseEducationIncre> baseEducations = odsBaseData.getBaseEducationIncres();
                return baseEducations.iterator();
            }, Encoders.bean(IdwTobBaseEducationIncre.class));

        Dataset<IdwTobBaseFunctionIncre> baseFunctionDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseFunctionIncres() && odsBaseData.getBaseFunctionIncres().size() > 0)
            .flatMap((FlatMapFunction<IdwTobBaseDataIncre, IdwTobBaseFunctionIncre>) odsBaseData -> {
                List<IdwTobBaseFunctionIncre> baseFunctions = odsBaseData.getBaseFunctionIncres();
                return baseFunctions.iterator();
            }, Encoders.bean(IdwTobBaseFunctionIncre.class));


        Dataset<IdwTobBaseCompanyIncre> baseCompanyDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseCompanyIncres() && odsBaseData.getBaseCompanyIncres().size() > 0)
            .flatMap((FlatMapFunction<IdwTobBaseDataIncre, IdwTobBaseCompanyIncre>) odsBaseData -> {
                List<IdwTobBaseCompanyIncre> baseCompanies = odsBaseData.getBaseCompanyIncres();
                return baseCompanies.iterator();
            }, Encoders.bean(IdwTobBaseCompanyIncre.class));


        Dataset<IdwTobBaseSalaryIncre> baseSalaryDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseSalaryIncre())
            .map((MapFunction<IdwTobBaseDataIncre, IdwTobBaseSalaryIncre>) IdwTobBaseDataIncre::getBaseSalaryIncre, Encoders.bean(IdwTobBaseSalaryIncre.class));

        Dataset<IdwTobBaseWorkIncre> baseWorkDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseWorkIncres() && odsBaseData.getBaseWorkIncres().size() > 0)
            .flatMap((FlatMapFunction<IdwTobBaseDataIncre, IdwTobBaseWorkIncre>) odsBaseData -> {
                List<IdwTobBaseWorkIncre> baseWorks = odsBaseData.getBaseWorkIncres();
                return baseWorks.iterator();
            }, Encoders.bean(IdwTobBaseWorkIncre.class));

        Dataset<IdwTobBaseWorkSalaryIncre> baseWorkSalaryDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseWorkSalaryIncres() && odsBaseData.getBaseWorkSalaryIncres().size() > 0)
            .flatMap((FlatMapFunction<IdwTobBaseDataIncre, IdwTobBaseWorkSalaryIncre>) odsBaseData -> {
                List<IdwTobBaseWorkSalaryIncre> baseWorkSalaries = odsBaseData.getBaseWorkSalaryIncres();
                return baseWorkSalaries.iterator();
            }, Encoders.bean(IdwTobBaseWorkSalaryIncre.class));

        Dataset<IdwTobBaseLevelIncre> baseLevelDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseLevelIncres() && odsBaseData.getBaseLevelIncres().size() > 0)
            .flatMap((FlatMapFunction<IdwTobBaseDataIncre, IdwTobBaseLevelIncre>) odsBaseData -> {
                List<IdwTobBaseLevelIncre> baseLevels = odsBaseData.getBaseLevelIncres();
                return baseLevels.iterator();
            }, Encoders.bean(IdwTobBaseLevelIncre.class));

        Dataset<IdwTobBaseIndustryTempIncre> baseIndustryTempDs = idwTobBaseDataDataset
            .filter((FilterFunction<IdwTobBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseIndustryTempIncres() && odsBaseData.getBaseIndustryTempIncres().size() > 0)
            .flatMap((FlatMapFunction<IdwTobBaseDataIncre, IdwTobBaseIndustryTempIncre>) odsBaseData -> {
                List<IdwTobBaseIndustryTempIncre> baseIndustryTemps = odsBaseData.getBaseIndustryTempIncres();
                return baseIndustryTemps.iterator();
            }, Encoders.bean(IdwTobBaseIndustryTempIncre.class));


        //save data to parquet
        baseCommonDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_common_incre");

//        baseContactDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
//            .saveAsTable("idw_tob_resume.base_contact_incre");

        baseCompanyDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_company_incre");

        baseEducationDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_education_incre");

        baseFunctionDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_function_incre");

        baseSalaryDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_salary_incre");

        baseWorkDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_work_incre");

        baseWorkSalaryDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_work_salary_incre");

        baseLevelDs.write().format("parquet").mode(SaveMode.Append).partitionBy("day")
            .saveAsTable("idw_tob_resume.base_level_incre");
        ...
        baseIndustryTempDs.join(industryMappingDs,
            ...
            .write().format("parquet").mode(SaveMode.Append).partitionBy("day")
...
//            .distinct().write().format("parquet").mode(SaveMode.Overwrite).saveAsTable("edw_ods_resumes.base_common");
//
//
//        //base_education
...
//            .distinct().write().format("parquet").mode(SaveMode.Overwrite).saveAsTable("edw_ods_resumes.base_education");
//
//        //base_function
//        odsBaseDataDs.selectExpr("resume_id", "wid", "function_id", "value", "algo_updated_at as updated_at")
//            .distinct().write().format("parquet").mode(SaveMode.Overwrite).saveAsTable("edw_ods_resumes.base_function");
//
//        //base_company
//        odsBaseDataDs.selectExpr("resume_id", "wid", "company_id", "algo_updated_at as updated_at")
//            .distinct().write().format("parquet").mode(SaveMode.Overwrite).saveAsTable("edw_ods_resumes.base_company");
