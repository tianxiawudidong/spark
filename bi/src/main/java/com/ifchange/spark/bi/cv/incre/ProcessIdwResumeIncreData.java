package com.ifchange.spark.bi.cv.incre;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.ifchange.spark.bi.bean.cv.*;
import com.ifchange.spark.bi.bean.cv.incre.*;
 ...
 * base_industry_incre
 * base_language_incre
 * base_certificate_incre
 */
public class ProcessIdwResumeIncreData {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessIdwResumeIncreData.class);
    ...
    public static void main(String[] args) {
        ...
        String extraIncrePath = args[2];
        String algoIncrePath = args[3];
        ...
        Dataset<ResumeExtra> resumeExtraDataset = sparkSession.read()
            ...
            .filter((FilterFunction<String>) s -> {
                ...
                String createdAt = split[8];
                String updatedAt = split[9];
        ...
        Dataset<OdsBaseDataIncre> odsBaseDataDs = resumeExtraDataset
            ...
            .map((MapFunction<Row, OdsBaseDataIncre>) row -> {
                OdsBaseDataIncre odsBaseData = new OdsBaseDataIncre();
                ...
                if (StringUtils.isNoneBlank(compressStr)) {
                    ...
                    if (null != jsonObject) {
                        ...
                        if (null != basic) {
                             ...
                             * base_common_incre
                             */
                            BaseCommonIncre baseCommon = new BaseCommonIncre();
                         ...
                         * base_education_incre
                         */
                        List<BaseEducationIncre> baseEducations = new ArrayList<>();
                            ...
                            if (educationSort.size() > 0) {
                                ...
                                for (Map.Entry<String, Object> entry : educationSort.entrySet()) {
                                    ...
                                    if ("N".equals(isDeleted)) {
                                        BaseEducationIncre baseEducation = new BaseEducationIncre();
                         ...
                         * base_function_incre
                         */
                        List<BaseFunctionIncre> baseFunctions = new ArrayList<>();
                                    ...
                                    if (value1 instanceof Map) {
                                        ...
                                        if (StringUtils.isNoneBlank(category)) {
                                            ...
                                            if (split.length == 2) {
                                                ...
                                                BaseFunctionIncre baseFunction = new BaseFunctionIncre();
                         ...
                         * base_company_incre
                         */
                        List<BaseCompanyIncre> baseCompanys = new ArrayList<>();
                        if (StringUtils.isNoneBlank(cvTrade)) {
                            ...
                            if (null != array && array.size() > 0) {
                                for (Integer i = 0; i < array.size(); i++) {
                                    BaseCompanyIncre baseCompany = new BaseCompanyIncre();
                         ...
                         */
                        if (null != basic) {
                            BaseSalaryIncre baseSalary = new BaseSalaryIncre();
...
//                                                            Pattern.compile("^(\\d+|\\d+\\.\\d+)$");
                         ...
                         * base_work_incre
                         */
                        List<BaseWorkIncre> baseWorks = new ArrayList<>();
                        ...
                        if (work instanceof Map) {
                            ...
                            if (sortWork.size() > 0) {
                                ...
                                for (Map.Entry<String, Object> entry : sortWork.entrySet()) {
                                    ...
                                    if ("N".equals(isDeleted)) {
                                        BaseWorkIncre baseWork = new BaseWorkIncre();
                         ...
                         * base_work_salary_incre
                         */
                        List<BaseWorkSalaryIncre> baseWorkSalaries = new ArrayList<>();
                        if (work instanceof Map) {
                            Map<String, Object> workJson = (Map<String, Object>) work;
                            Map<String, Object> sortWork = SortMapUtils.workSort(workJson);
                            if (sortWork.size() > 0) {
                                ...
                                for (Map.Entry<String, Object> entry : sortWork.entrySet()) {
                                    ...
                                    String isDeleted = null != workDetail.get("is_deleted") ?
                                        String.valueOf(workDetail.get("is_deleted")) : "N";
                                    if ("N".equals(isDeleted)) {
                                        BaseWorkSalaryIncre baseWorkSalary = new BaseWorkSalaryIncre();
...
//                                                            Pattern.compile("^(\\d+|\\d+\\.\\d+)$");
                         ...
                         * base_work_skill_incre
                         */
                        List<BaseWorkSkillIncre> baseWorkSkills = new ArrayList<>();
                                            ...
                                            for (Map<String, Object> desc : descList) {
                                                ...
                                                if (null != entityIdCandidatesList && entityIdCandidatesList.size() > 0) {
                                                    for (Map<String, Object> entityIdCandidates : entityIdCandidatesList) {
                                                        BaseWorkSkillIncre baseWorkSkill = new BaseWorkSkillIncre();
                                                        baseWorkSkill.setDay(date);
                        ...
                        /**
                         * base_industry_temp_incre
                         */
                        List<BaseIndustryTempIncre> baseIndustryTemps = new ArrayList<>();
                        if (StringUtils.isNoneBlank(cvTrade)) {
                            JSONArray array = null;
                            try {
                                array = JSONObject.parseArray(cvTrade);
                                    ...
                                    if (null != tradeJson && tradeJson.size() > 0) {
                                        ...
                                        if (null != tradeList && tradeList.size() > 0) {
                                            for (int industryId : tradeList) {
                                                BaseIndustryTempIncre baseIndustryTemp = new BaseIndustryTempIncre();
                         ...
                         * base_level_incre
                         */
                        List<BaseLevelIncre> baseLevels = new ArrayList<>();
                        if (StringUtils.isNoneBlank(cvTitle) && !StringUtils.equals("\"\"", cvTitle)) {
                            ...
                            if (null != cvTitleJson && cvTitleJson.size() > 0) {
                                for (Map.Entry<String, Object> entry : cvTitleJson.entrySet()) {
                                    BaseLevelIncre baseLevel = new BaseLevelIncre();
                             ...
                             * base_language_incre
                             */
                            List<BaseLanguageIncre> baseLanguages = new ArrayList<>();
                            ...
                            if (null != languageJson && languageJson.size() > 0) {
                                ...
                                for (Map.Entry<String, Object> entry : languageJson.entrySet()) {
                                    BaseLanguageIncre baseLanguage = new BaseLanguageIncre();
                                    baseLanguage.setDay(date);
                             ...
                             * base_certificate_incre
                             */
                            List<BaseCertificateIncre> baseCertificates = new ArrayList<>();
                            ...
                            if (null != certificateJson && certificateJson.size() > 0) {
                                for (Map.Entry<String, Object> entry : certificateJson.entrySet()) {
                                    BaseCertificateIncre baseCertificate = new BaseCertificateIncre();
                                    baseCertificate.setDay(date);
                ...
                return odsBaseData;
            }, Encoders.bean(OdsBaseDataIncre.class));

        odsBaseDataDs.persist();

        Dataset<BaseCommonIncre> baseCommonDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseCommon())
            .map((MapFunction<OdsBaseDataIncre, BaseCommonIncre>) OdsBaseDataIncre::getBaseCommon, Encoders.bean(BaseCommonIncre.class));

        Dataset<BaseEducationIncre> baseEducationDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseEducations() && odsBaseData.getBaseEducations().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseEducationIncre>) odsBaseData -> {
                List<BaseEducationIncre> baseEducations = odsBaseData.getBaseEducations();
                return baseEducations.iterator();
            }, Encoders.bean(BaseEducationIncre.class));

        Dataset<BaseFunctionIncre> baseFunctionDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseFunctions() && odsBaseData.getBaseFunctions().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseFunctionIncre>) odsBaseData -> {
                List<BaseFunctionIncre> baseFunctions = odsBaseData.getBaseFunctions();
                return baseFunctions.iterator();
            }, Encoders.bean(BaseFunctionIncre.class));


        Dataset<BaseCompanyIncre> baseCompanyDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseCompanys() && odsBaseData.getBaseCompanys().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseCompanyIncre>) odsBaseData -> {
                List<BaseCompanyIncre> baseCompanies = odsBaseData.getBaseCompanys();
                return baseCompanies.iterator();
            }, Encoders.bean(BaseCompanyIncre.class));


        Dataset<BaseSalaryIncre> baseSalaryDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseSalary())
            .map((MapFunction<OdsBaseDataIncre, BaseSalaryIncre>) OdsBaseDataIncre::getBaseSalary, Encoders.bean(BaseSalaryIncre.class));

        Dataset<BaseWorkIncre> baseWorkDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseWorks() && odsBaseData.getBaseWorks().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseWorkIncre>) odsBaseData -> {
                List<BaseWorkIncre> baseWorks = odsBaseData.getBaseWorks();
                return baseWorks.iterator();
            }, Encoders.bean(BaseWorkIncre.class));

        Dataset<BaseWorkSalaryIncre> baseWorkSalaryDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseWorkSalaries() && odsBaseData.getBaseWorkSalaries().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseWorkSalaryIncre>) odsBaseData -> {
                List<BaseWorkSalaryIncre> baseWorkSalaries = odsBaseData.getBaseWorkSalaries();
                return baseWorkSalaries.iterator();
            }, Encoders.bean(BaseWorkSalaryIncre.class));

        Dataset<BaseWorkSkillIncre> baseWorkSkillDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseWorkSkills() && odsBaseData.getBaseWorkSkills().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseWorkSkillIncre>) odsBaseData -> {
                List<BaseWorkSkillIncre> baseWorkSkills = odsBaseData.getBaseWorkSkills();
                return baseWorkSkills.iterator();
            }, Encoders.bean(BaseWorkSkillIncre.class));

        Dataset<BaseLevelIncre> baseLevelDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseLevels() && odsBaseData.getBaseLevels().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseLevelIncre>) odsBaseData -> {
                List<BaseLevelIncre> baseLevels = odsBaseData.getBaseLevels();
                return baseLevels.iterator();
            }, Encoders.bean(BaseLevelIncre.class));

        Dataset<BaseIndustryTempIncre> baseIndustryTempDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseIndustryTemps() && odsBaseData.getBaseIndustryTemps().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseIndustryTempIncre>) odsBaseData -> {
                List<BaseIndustryTempIncre> baseIndustryTemps = odsBaseData.getBaseIndustryTemps();
                return baseIndustryTemps.iterator();
            }, Encoders.bean(BaseIndustryTempIncre.class));

        Dataset<BaseLanguageIncre> baseLanguageDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseLanguages() && odsBaseData.getBaseLanguages().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseLanguageIncre>) odsBaseData -> {
                List<BaseLanguageIncre> baseLanguages = odsBaseData.getBaseLanguages();
                return baseLanguages.iterator();
            }, Encoders.bean(BaseLanguageIncre.class));

        Dataset<BaseCertificateIncre> baseCertificateDs = odsBaseDataDs
            .filter((FilterFunction<OdsBaseDataIncre>) odsBaseData -> null != odsBaseData.getBaseCertificates() && odsBaseData.getBaseCertificates().size() > 0)
            .flatMap((FlatMapFunction<OdsBaseDataIncre, BaseCertificateIncre>) odsBaseData -> {
                List<BaseCertificateIncre> baseCertificates = odsBaseData.getBaseCertificates();
                return baseCertificates.iterator();
            }, Encoders.bean(BaseCertificateIncre.class));
        ...
        baseCommonDs.write()
            ...
            .partitionBy("day")
            .saveAsTable("idw_resume.base_common_incre");

        baseCompanyDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_company_incre");

        baseEducationDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_education_incre");

        baseFunctionDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_function_incre");

        baseSalaryDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_salary_incre");

        baseWorkDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_work_incre");

        baseWorkSalaryDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_work_salary_incre");

        baseWorkSkillDs.distinct()
            .write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_work_skill_incre");

        baseLevelDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_level_incre");
        ...
        baseIndustryTempDs.join(industryMappingDs,
            ...
            .select(baseIndustryTempDs.col("resume_id"),
                ...
                baseIndustryTempDs.col("day"))
            .write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_industry_incre");

        baseLanguageDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_language_incre");

        baseCertificateDs.write()
            .mode(SaveMode.Append)
            .partitionBy("day")
            .saveAsTable("idw_resume.base_certificate_incre");
