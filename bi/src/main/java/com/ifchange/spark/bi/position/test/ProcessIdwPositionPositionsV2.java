package com.ifchange.spark.bi.position.test;
 ...
 */
public class ProcessIdwPositionPositionsV2 {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessIdwPositionPositionsV2.class);
...
//                idwPositions.setCompany_id(companyId);
        ...
        //save data into hive
//        idwPositionsDs.write().mode(SaveMode.Overwrite).saveAsTable("idw_positions.positions_v3");

        idwPositionsDs.registerTempTable("positions_temp");

        // 写入数据库
        sparkSession.sql("insert overwrite table idw_positions.positions_v3 select * from positions_temp");
