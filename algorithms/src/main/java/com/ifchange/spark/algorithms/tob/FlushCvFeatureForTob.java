...
public class FlushCvFeatureForTob {

    private static final Logger LOG = LoggerFactory.getLogger(FlushCvFeatureForTob.class);
                            ...
                            if (StringUtils.isNoneBlank(resumeContent)) {
                                ...
                                if (null != compress) {
                                    ...
                                    if (StringUtils.isNoneBlank(cvFeature)) {
                                        ...
                                        String value = MyString.toUnicode(cvFeature, false, false);
                                        String encoder = new String(Base64.getEncoder().encode(MyString.gzipCompress(value, "UTF-8")));
                                        String param = "'" + "cv_feature" + "'" + "," + "'" + encoder + "'";
