...
public class FlushCvEducationForTob {

    private static final Logger LOG = LoggerFactory.getLogger(FlushCvEducationForTob.class);
                            ...
                            if (StringUtils.isNoneBlank(resumeContent)) {
                                ...
                                if (null != compress) {
                                    ...
                                    if (StringUtils.isNoneBlank(cvEducation)) {
                                        ...
                                        String value = MyString.toUnicode(cvEducation, false, false);
                                        String encoder = new String(Base64.getEncoder().encode(MyString.gzipCompress(value, "UTF-8")));
                                        String param = "'" + "cv_education" + "'" + "," + "'" + encoder + "'";
