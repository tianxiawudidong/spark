...
import com.ifchange.spark.algorithms.http.CvWorkYearHttp;
...
public class FlushCvWorkYearForIcdc {

    private static final Logger LOG = LoggerFactory.getLogger(FlushCvWorkYearForIcdc.class);
    ...
    public static void main(String[] args) {
                    ...
                    if (StringUtils.isNoneBlank(line)) {
                        ...
                        try {
                            ...
                            if (StringUtils.isNoneBlank(compressStr) && !StringUtils.equals("null", compressStr)) {
                                ...
                                if (null != compress) {
                                    String cvWorkYear = null;
                                    try {
                                        cvWorkYear = CvAlgorithmsTagUtil.callCvWorkYear(id, compress);
                                        LOG.info("id:{} cv_workyear:{}", id, cvWorkYear);
                                    } catch (Exception e) {
                                        LOG.info("id:{} call cv_workyear error:{}", id, e.getMessage());
                                    }
                                    if (StringUtils.isNoneBlank(cvWorkYear)) {
                                        String param = "'" + "cv_workyear" + "'" + "," + "'" + cvWorkYear + "'";
                                        ...
                                        try {
                                            ...
                                            LOG.info("id:{} update cv_workyear flag:{}", id, flag);
                                            if (flag != 0) {
                                        ...
                                        LOG.info("id:{} cv_workyear result is empty", id);
        ...
        LOG.info("resume no cv_workyear result accumulator value:{}", resumeWithNoWorkAccumulator.value());
