...
public class CvEducationHttp extends AlgorithmsHttp implements Callable<String> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CvEducationHttp.class);

    private static ThreadPoolExecutor threadPoolExecutor;

    private static final int ThreadNumber = 2;

    public CvEducationHttp(String resumeId, Map<String, Object> compress) throws Exception {
        super();
    ...
    public String call() {
        ...
        if (null != pMap && pMap.size() > 0) {
            ...
            try {
                ...
                logger.info("cv_education call http error:{},param:{}", e.getMessage(), param);
            }
        }
        return result;
    }

    public String start(CvEducationHttp cvTitleHttp) throws Exception {
