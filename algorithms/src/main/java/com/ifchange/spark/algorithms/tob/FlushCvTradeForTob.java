...
public class FlushCvTradeForTob {

    private static final Logger LOG = LoggerFactory.getLogger(FlushCvTradeForTob.class);
                                ...
                                if (null != compress) {
                                    ...
                                    if (StringUtils.isNoneBlank(cvTrade)) {
                                        ...
                                        try {
                                            ...
                                            LOG.info(sql2);
                                            boolean flag = index < 4 ? mysql134.saveTobAlgorithms(sql2)
                                                : mysql167.saveTobAlgorithms(sql2);
