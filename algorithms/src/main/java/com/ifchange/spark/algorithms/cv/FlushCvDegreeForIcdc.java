...
public class FlushCvDegreeForIcdc {

    private static final Logger LOG = LoggerFactory.getLogger(FlushCvDegreeForIcdc.class);
    ...
    public static void main(String[] args) {
                            ...
                            if (StringUtils.isNoneBlank(compressStr) && !StringUtils.equals("null", compressStr)) {
                                ...
                                if (null != compress) {
                                    ...
                                    if (StringUtils.isNoneBlank(cvDegree)) {
                                        String param = "'" + "cv_degree" + "'" + "," + "'" + cvDegree + "'";
        ...
        LOG.info("resume no cv_degree result accumulator value:{}", resumeWithNoWorkAccumulator.value());
