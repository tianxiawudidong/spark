 ...
 * @author root
 */
public class JdRealCorporationsHttp extends AlgorithmsHttp implements Callable<String> {

    private List<Map<String, Object>> workList = new ArrayList<>();

    private static final Logger logger = LoggerFactory.getLogger(JdRealCorporationsHttp.class);
    ...
    /**
     * @param positionId          id
     * @param realCorporationName real_corporation_name
     * @throws Exception exception
     */
    public JdRealCorporationsHttp(String positionId, String realCorporationName) throws Exception {
        super();
        ...
        if (StringUtils.isNoneBlank(realCorporationName)) {
            Map<String, Object> map = new HashMap<>();
            map.put("work_id", "0");
            map.put("company_name", realCorporationName);
            workList.add(map);
        }
    ...
    public String start(JdRealCorporationsHttp jdRealCorporationsHttp) throws Exception {
        String result = "";
        Future<String> submit = threadPoolExecutor.submit(jdRealCorporationsHttp);
