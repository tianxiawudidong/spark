...
public class FlushCvTagForIcdc {

    private static final Logger LOG = LoggerFactory.getLogger(FlushCvTagForIcdc.class);
    ...
    public static void main(String[] args) {
                            ...
                            if (StringUtils.isNoneBlank(compressStr) && !StringUtils.equals("null", compressStr)) {
                                ...
                                if (null != compress) {
                                    ...
                                    if (StringUtils.isNoneBlank(tagPredict)) {
                                        tagPredict = MyString.toUnicode(tagPredict, false);
                                        tagPredict = tagPredict.replace("'", "\\'");
                                        String param = "'" + "cv_tag" + "'" + "," + "'" + tagPredict + "'";
        ...
        LOG.info("resume no cv_tag result accumulator value:{}", resumeWithNoWorkAccumulator.value());
