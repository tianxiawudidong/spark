...
public class FlushCvWorkYearForTob {

    private static final Logger LOG = LoggerFactory.getLogger(FlushCvWorkYearForTob.class);
                            ...
                            if (StringUtils.isNoneBlank(resumeContent)) {
                                ...
                                if (null != compress) {
                                    ...
                                    if (StringUtils.isNoneBlank(cvWorkYear)) {
                                        ...
                                        String value = MyString.toUnicode(cvWorkYear, false, false);
                                        String encoder = new String(Base64.getEncoder().encode(MyString.gzipCompress(value, "UTF-8")));
                                        String param = "'" + "cv_workyear" + "'" + "," + "'" + encoder + "'";
