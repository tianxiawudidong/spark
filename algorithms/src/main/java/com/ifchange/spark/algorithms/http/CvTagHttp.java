 ...
 * @author root
 */
public class CvTagHttp extends AlgorithmsHttp implements Callable<String> {
...
//    private static final String url="http://testing2.nlp.rpc/function_tag";
    ...
    private static final Logger logger = LoggerFactory.getLogger(CvTagHttp.class);
    ...
    public CvTagHttp(String resumeId, Map<String, Object> compress) throws Exception {
        super();
...
//            logger.info(param);
            ...
            try {
                ...
                logger.info("cv_tag call http error:{},param:{}", e.getMessage(),param);
            }
        }
        return result;
    }

    public String start(CvTagHttp cvTagHttp) throws Exception {
        Future<String> submit = threadPoolExecutor.submit(cvTagHttp);
        return submit.get();
    }
